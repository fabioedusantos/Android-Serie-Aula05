# Aula 05 (Série) - Projeto DAO (Data Access Object)
...
Aplicativo Android utilizado para demonstração de uso simplificado de armazenamento, alteração, exclusão e exibição de informações junto ao SGBD SQLite nativo Android...
